...
import { X, Play, ExternalLink, Star } from "lucide-react";
...
export const MediaModal: React.FC<MediaModalProps> = ({ item, onClose }) => {
  ...
  const youtubeId = item.youtubeVideoUrl
    ? getYoutubeId(item.youtubeVideoUrl)
    : null;
            ...
            <div className="flex items-center space-x-3">
              ...
              {item.featured && (
                ...
                >
                  ...
                  <span className="relative z-10">Showcased</span>
                </a>
              )}
            </div>
          </div>
