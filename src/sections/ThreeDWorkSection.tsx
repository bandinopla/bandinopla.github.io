...
export const ThreeDSection = ()=>{
    return <div>
        ...
        <iframe className="bsha" width="800" height="600"src="https://www.youtube-nocookie.com/embed/KbyhSHsmRDE?si=EnUqdmNVel3nTPXZ" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        <Aclaracion/>
        </div>
}